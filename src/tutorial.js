...
const TUT_STEPS = [
  ...
  { title: 'Keep your puffling fed',
    text: 'Deliveries fill the puffling meter at the top right and help it grow. The striped part is what your beak will add; extra fish give it a full belly. If the meter runs out, race to a burrow.',
    glow: 'hunger', read: 9, hungerOn: true },
